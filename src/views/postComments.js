  ...
  <div class="comment-user">
    ...
    <div class= 'hide edit-comment'>
      ...
      <div class='container-btn'>
       <button class="btn-save-post btn-post" id="btnSave">Guardar</button>
       <button class="btn-cancel-post btn-post" id="btnCancel">Cancelar</button>
      </div>
    </div>
    <div id="div-comment-${comment.id}" class='post-publised-comment'><span class='div-comment'> ${comment.name}<br> ${comment.date}<br></span>${comment.textComment}</div>
      <div class="container-menu-post">
        ...
        <nav class="nav-post hide" id='nav-${comment.id}'>
          <ul class="menu-post">
            <li class="btn-post-menu btn-edit">Editar</li>
            <li class="btn-post-menu btn-delete">Eliminar</li>
          </ul>
        </nav>
      </div>
  </div>
`;
  ...
  const btnEdit = viewComments.querySelector('.btn-edit');
  ...
  btnCancel.addEventListener('click', () => {
    textComment.value = `${comment.textComment}`;
    editComment();
  });
  ...
  // Eliminar comentario
  const btnDelete = viewComments.querySelector('.btn-delete');
